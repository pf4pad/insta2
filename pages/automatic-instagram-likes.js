    ...
    return (
        <div className={styles.background} style={{background:"url('instagramBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy automatic Instagram likes from MakeTop. Cheap instant and regular monthly delivery of 100% high quality followers packages. Payment by crypto"/>
                <meta name="og:description" content="Buy automatic Instagram likes from MakeTop. Cheap instant and regular monthly delivery of 100% high quality followers packages. Payment by crypto"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy Automatic Instagram Likes Guaranteed by MakeTop #1"/>
                <meta property=" title" content="Buy Automatic Instagram Likes Guaranteed by MakeTop #1"/>
                    ...
                    <Layer type="link">
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                <img src="/buyLikesPhoto.png" alt="Automatic Instagram Likes"   className={styles.instagramImg} />
