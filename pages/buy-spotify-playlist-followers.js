    ...
    return (
        <div className={styles.background} style={{background:"url('/spotifyBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy Spotify playlist followers is a good way to get popular on social media. Easy payment by crypto or card. High-quality followers and safety service"/>
                <meta name="og:description" content="Buy Spotify playlist followers is a good way to get popular on social media. Easy payment by crypto or card. High-quality followers and safety service"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy Spotify Playlist Followers - 2 Steps to Result - MakeTop"/>
                <meta property="title" content="Buy Spotify Playlist Followers - 2 Steps to Result - MakeTop"/>
                ...
                <meta property="og:url" content="https://maketop.io/buy-spotify-playlist-followers"/>
                <link rel="canonical" href="https://maketop.io/buy-spotify-playlist-followers"/>
            </Head>
                    ...
                    <div className={`container`}>
                        ...
                        <div className={styles.phone2}>
                            <div className={buyLikesStyles.secondTitle}>
                                ...
                                />
                            </div> <img src="/spotifyPhoto.png" alt="buy spotify playlist followers"  className={styles.spotifyImg} />
                        </div>
