    ...
    return (
        <div className={styles.background} style={{background:"url('tiktokBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy TikTok likes from #1 MakeTop site. Only 2 steps: just choose our package and pay by crypto. Fast safe delivery. No password is required"/>
                <meta name="og:description" content="Buy TikTok likes from #1 MakeTop site. Only 2 steps: just choose our package and pay by crypto. Fast safe delivery. No password is required"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy TikTok Likes - 100% Real Looking - MakeTop"/>
                <meta property="title" content="Buy TikTok Likes - 100% Real Looking - MakeTop"/>
                    ...
                    <Layer type="tiktok">
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                <img src="/tiktokPhoto.png" alt="buy tiktok likes" className={styles.tiktokImg} />
