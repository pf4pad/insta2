    ...
    return (
        <div className={styles.background} style={{background:"url('tiktokBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy TikTok views from #1 MakeTop site. Only 2 steps: just choose our views package and pay by crypto. Fast safe delivery. No password is required"/>
                <meta name="og:description" content="Buy TikTok views from #1 MakeTop site. Only 2 steps: just choose our views package and pay by crypto. Fast safe delivery. No password is required"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy TikTok Views From The world's #1 Site (2022)- tagiamtop"/>
                <meta property="title" content="Buy TikTok Views - 100% Real Looking - MakeTop"/>
                    ...
                    <Layer type="tiktok">
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                <img src="/tiktokPhoto.png" alt="buy tiktok views" className={styles.tiktokImg} />
