    ...
    return (
        <div className={styles.background} style={{background:"url('/twitterBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy Twitter followers with simple steps and normal-looking gradual delivery. Top followers from #1 MakeTop platform. Get results under 24H. Pay by crypto"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy Twitter Followers - Normal Gradual Delivery - MakeTop"/>
                ...
                <meta property="og:url" content="https://maketop.io/buy-twitter-followers"/>
                ...
                <Layer type="twitter">
                    <div className={`container`}>
                        ...
                        <div className={styles.phone2}>
                            ...
                            <img src="/twitterPhoto1.png" alt="buy twitter followers" className={styles.twitterImg1} />
                            <img src="/twitterPhoto2.png" alt="buy twitter followers cheap"   className={styles.twitterImg2} />
                        </div>
