    ...
    return (
        <div className={styles.background} style={{background:"url('/youtubeBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy YouTube comments from MakeTop for your video. Get unlimited high-quality comments packages with payment by crypto or credit card. No password and risk"/>
                <meta name="og:description" content="Buy YouTube comments from MakeTop for your video. Get unlimited high-quality comments packages with payment by crypto or credit card. No password and risk"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy YouTube Comments - High Quality - 100% Real Looking"/>
                <meta property="title" content="Buy YouTube Comments - High Quality - 100% Real Looking"/>
                    ...
                    <Layer type="youtube">
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                <img src="/youtubePhoto.png" alt="buy youtube comments"  className={styles.youtubeImg} />
