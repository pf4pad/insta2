    ...
    return (
        <div className={styles.background} style={{background:"url('/youtubeBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy YouTube likes from MakeTop. Get unlimited high-quality likes packages with payment by crypto or credit card. No password and risk"/>
                <meta name="og:description" content="Buy YouTube likes from MakeTop. Get unlimited high-quality likes packages with payment by crypto or credit card. No password and risk"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy YouTube Likes - 100% High Quality - Instant Delivery"/>
                <meta property="title" content="Buy YouTube Likes - 100% High Quality - Instant Delivery"/>
                    ...
                    <Layer type="youtube">
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                <img src="/youtubePhoto.png" alt="buy youtube likes" className={styles.youtubeImg} />
