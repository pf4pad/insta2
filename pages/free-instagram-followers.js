    ...
    return (
        <div className={styles.background} style={{background:"url('instagramBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Free Instagram followers from MakeTop platform is recommended by influencers. Get 10 followers immediately without password and personal info"/>
                <meta name="og:description" content="Free Instagram followers from MakeTop platform is recommended by influencers. Get 10 followers immediately without password and personal info"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Get Free Instagram Followers - Test 10 - 100% Work"/>
                <meta property=" title" content="Get Free Instagram Followers - Test 10 - 100% Work"/>
                ...
                <Layer type="link">
                    <div className={`container`}>
                        ...
                        <div className={styles.phone}>
                            <img src="/buyLikesPhoto.png" alt="Free Instagram Followers"    className={styles.instagramImg} />
                            <div className={buyLikesStyles.mainTitle}>
                                ...
                                <ButtonComponent text={'Free 10 Instagram followers'} id={"FREE10FOLLOWERS"} type={'instagram'} onClick={()=>
                                    router.push({
                                        pathname: '/basket',
