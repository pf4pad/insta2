    ...
    return (
        <div className={styles.background} style={{background:"url('instagramBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Free Instagram likes from MakeTop platform is recommended by influencers. Get 25 likes immediately without password and personal information"/>
                <meta name="description" content="Free Instagram likes from MakeTop platform is recommended by influencers. Get 25 likes immediately without password and personal information"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Free Instagram Likes - Get Test 25 - 100% Work"/>
                <meta property="title" content="Free Instagram Likes - Get Test 25 - 100% Work"/>
                ...
                <Layer type="link">
                    <div className={`container`}>
                        ...
                        <div className={styles.phone}>
                            <img src="/buyLikesPhoto.png" alt="Free Instagram Likes"    className={styles.instagramImg} />
                            <div className={buyLikesStyles.mainTitle}>
                                ...
                                <ButtonComponent text={'Free 10 Instagram likes'} type={'instagram'} id={"FREE25LIKES"} onClick={()=>{
                                    router.push({
                                        pathname: '/basket',
